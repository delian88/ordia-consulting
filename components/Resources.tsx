      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          ...
          <div className="reveal bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center text-center">
            ...
            <button className="px-8 py-3 bg-slate-100 text-blue-900 rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-blue-100 transition-all">Request Setup</button>
          </div>
          ...
          <div className="reveal bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center text-center">
            ...
            <button className="px-8 py-3 bg-slate-100 text-blue-900 rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-blue-100 transition-all">Book Training</button>
          </div>
          ...
          <div className="reveal bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center text-center">
            ...
            <button className="px-8 py-3 bg-slate-100 text-blue-900 rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-blue-100 transition-all">Get Support</button>
          </div>
          ...
          <div className="reveal bg-white p-10 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center text-center">
            ...
            <button className="px-8 py-3 bg-slate-100 text-blue-900 rounded-full font-bold text-[10px] uppercase tracking-widest hover:bg-blue-100 transition-all">Schedule Review</button>
          </div>
        </div>
      </div>
    </div>
