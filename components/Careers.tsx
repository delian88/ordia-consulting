      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center mb-24">
          ...
          <div className="reveal-right bg-slate-900 p-12 rounded-[3rem] text-white">
            <h3 className="text-2xl font-serif font-bold mb-8">Our HR & Staffing Services</h3>
            <div className="space-y-6">
              {[
                "Staffing Solutions and Augmentation support",
                ...
                <div key={i} className="p-6 border border-white/10 rounded-2xl hover:bg-white/5 transition-all cursor-pointer flex justify-between items-center group">
                  <div>
                    ...
                    <p className="text-white/40 text-[10px] uppercase tracking-widest">Advisory & Management Support</p>
                  </div>
            ...
            <p className="mt-10 text-white/40 text-xs text-center">Inquire at hr@ordiafinances.com or info@ordiafinances.com</p>
          </div>
        </div>
      </div>
    </div>
