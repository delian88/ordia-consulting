      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-400/20 text-blue-400 text-[10px] font-bold uppercase tracking-[0.2em] mb-8 reveal active">
            ...
            <h1 className="text-6xl lg:text-8xl font-serif font-bold text-white mb-8 leading-[1.1] reveal active">
              Navigating Your <br />
              <span className="italic font-normal text-blue-400">Financial Future.</span>
            </h1>
            
            <p className="text-slate-400 text-lg lg:text-xl mb-12 max-w-xl leading-relaxed reveal active delay-200">
              Professional accounting, tax, and consulting services for business owners, executives, and independent professionals. We are affordable, experienced, and friendly.
            </p>
            
            <div className="flex flex-wrap gap-5 reveal active delay-300">
              <a 
                href="#contact" 
                className="px-10 py-5 bg-blue-600 hover:bg-blue-500 text-white rounded-full font-bold text-sm uppercase tracking-widest transition-all hover:scale-105 shadow-2xl shadow-blue-600/20"
              >
            ...
            <div className="mt-20 grid grid-cols-3 gap-8 reveal active delay-500">
              ...
              <div className="border-l border-white/10 pl-8">
                <p className="text-3xl font-serif font-bold text-white mb-1">Accurate</p>
                <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Accounting</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative hidden lg:block">
            <div className="relative z-10 reveal-right active delay-300">
              <div className="absolute -inset-4 bg-gradient-to-tr from-blue-600/20 to-transparent blur-3xl"></div>
              <img 
              ...
              <div className="absolute -bottom-8 -left-8 p-8 dark-glass rounded-2xl shadow-2xl reveal delay-500">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-xs uppercase tracking-wider">CPA Certified Services</p>
                  </div>
                </div>
              </div>
            </div>
