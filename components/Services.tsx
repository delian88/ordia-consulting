...
export const servicesData: Service[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { title: "WIP Schedules", detail: "Comprehensive management and tracking of Work-in-Progress schedules for accurate reporting." },
  ...
  },
  {
    ...
    fullDescription: "OCS provides small businesses with the technical expertise needed to navigate growth. We serve as your trusted advisor, helping you make informed decisions from startup phase through expansion.",
      ...
      <div className="container mx-auto px-6">
        ...
        {isStandalone && (
          <div className="mt-32 pt-24 border-t border-slate-100">
             <div className="max-w-4xl mx-auto text-center mb-20 reveal">
              <span className="text-blue-600 font-bold uppercase tracking-[0.25em] text-[10px] mb-4 block">Fractional CFO & Support</span>
              ...
              <p className="text-slate-500 text-lg md:text-xl font-light leading-relaxed">
                OCS provides expert support for every stage of your business lifecycle. If you’re ready to take your business to the next level through personalized guidance, contact us today.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                { title: "Technical Training", desc: "Professional training for your in-house staff to elevate internal accounting performance.", icon: "TR" },
