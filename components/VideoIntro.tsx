...
const introScript = [
  { 
    text: "Ordia Consulting Services, or O-C-S, is a premier financial services firm providing expert Outsourced C-P-A and business consulting solutions across the United States.", 
    delay: 0,
  ...
  { 
    text: "With over twenty years of experience across government, non-profit, and for-profit sectors, we deliver tangible results that remediate internal control issues.", 
    delay: 17000,
    video: "https://player.vimeo.com/external/371804246.hd.mp4?s=7b30f8c383f9827608e5a7b0365780a4a8d052d0&profile_id=174"
  },
  { 
    text: "From specialized construction accounting and healthcare financial management to comprehensive tax preparation, O-C-S provides technical excellence.", 
    delay: 26000,
    video: "https://player.vimeo.com/external/494254081.hd.mp4?s=548c775d165f1227092c47c7c10b7b1b3699b8f0&profile_id=174"
  },
  { 
    text: "Partner with us for a three-hundred and sixty degree approach to your financial strategy. Your success is our mission.", 
    delay: 35000,
...
export const VideoIntro: React.FC<VideoIntroProps> = ({ onNavigate }) => {
  ...
  const handleAiVideoGeneration = async () => {
    try {
      ...
      if (!hasKey) {
        ...
        // Billing link must be provided as per instructions
        console.info("Please select a billing-enabled key: https://ai.google.dev/gemini-api/docs/billing");
      }
      ...
      const loadingMessages = [
        ...
        "Rendering business excellence...",
        "Applying professional grade color correction...",
      ...
      let operation = await ai.models.generateVideos({
        ...
        prompt: 'A cinematic wide-angle shot of a modern, glass-walled financial office in Baltimore at sunset, with professionals discussing strategy around a glowing digital table, 4k, hyper-realistic, professional lighting, slow motion camera movement',
        config: {
          numberOfVideos: 1,
          resolution: '1080p',
          aspectRatio: '16:9'
      ...
      setIsGeneratingAiVideo(false);
      // Instructions: If requested entity not found, reset key
  ...
  return (
    <section id="video-intro" className="py-24 bg-[#001226] relative overflow-hidden">
      {/* Cinematic Background */}
      <div className="absolute top-0 right-0 w-1/2 h-full bg-blue-500/10 blur-[150px] rounded-full -mr-32"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-5 reveal-left">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-white mb-8 leading-tight">
              Cinematic <br />
              <span className="italic font-normal text-blue-400">Financial Strategy.</span>
            </h2>
            <p className="text-slate-400 text-lg font-light leading-relaxed mb-10">
              OCS provides professional oversight through immersive technical strategy. Experience our mission across industries—from global boardrooms to specialized construction sites.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
               ...
               >
                 {isGeneratingAiVideo ? (
                    <span className="animate-pulse">Generating Vision...</span>
                 ) : (
                    <>
              ...
              <div className="relative aspect-video rounded-[3rem] overflow-hidden shadow-2xl border border-white/5 bg-black">
                ...
                {!isPlaying && !isGeneratingAiVideo && !generatedVideoUrl && (
                  <div className="absolute inset-0 z-40 bg-slate-900 flex flex-col items-center justify-center">
                    ...
                    <p className="mt-6 text-[10px] font-bold text-blue-400 uppercase tracking-widest relative z-50">Play Cinematic Presentation</p>
                  </div>
                )}
                  ...
                  <div className="w-full h-full relative">
                    ...
                    {!isVoiceLoading && currentCaption && (
                      <div className="absolute bottom-10 left-0 right-0 z-20 flex justify-center px-8 animate-fade-in-up">
                        <div className="bg-blue-900/60 backdrop-blur-md border border-white/10 px-8 py-4 rounded-3xl text-center max-w-lg shadow-2xl">
