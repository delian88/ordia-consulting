        ...
        <div className="pt-8 md:pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6 md:gap-10">
          <div className="flex flex-col items-center md:items-start gap-1">
            ...
            <p className="text-[9px] tracking-[0.2em] uppercase text-slate-600 font-medium">
              Powered by <a href="https://azariahmg.com/" target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:text-blue-400 transition-colors font-bold underline decoration-blue-500/30 underline-offset-4">Azariah Management Group</a>, Sealed by WorldAiForce
            </p>
          </div>
