      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            ...
            { title: "Training", desc: "Professional training for your in-house accountants and bookkeepers to elevate internal performance.", icon: "TR" },
            ...
            { title: "Cash Flow Management", desc: "Precise financial analysis and reporting to keep your business's liquidity optimized.", icon: "CF" }
          ].map((item, i) => (
            <div key={i} className="reveal bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 hover:shadow-2xl hover:shadow-blue-900/5 transition-all group">
              ...
              {/* Fixed: Replaced item.desc || item.detail with item.desc after normalizing properties to 'desc' */}
